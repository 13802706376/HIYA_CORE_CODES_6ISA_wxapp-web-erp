...
import com.yunnex.ops.erp.modules.sys.security.FormAuthenticationFilter;
...
//			// 查询id
//			int updatePasswordFlag = systemService.getUpdatePasswordFlag(userid);
//			if (updatePasswordFlag == 0) {
//				// 转向修改密码页：
//				return "redirect:" + adminPath + "/sys/user/modifyPwd" + "?updatePasswordFlag";
//			}
//		}
...
//		try {
//			byte[] bytes = com.yunnex.ops.erp.common.utils.FileUtils.readFileToByteArray(
//					com.yunnex.ops.erp.common.utils.FileUtils.getFile("c:\\sxt.dmp"));
